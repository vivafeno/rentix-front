...
export function companyControllerCreateTenant(http: HttpClient, rootUrl: string, params: CompanyControllerCreateTenant$Params, context?: HttpContext): Observable<StrictHttpResponse<Company>> {
