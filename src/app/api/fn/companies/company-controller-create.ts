...
export function companyControllerCreate(http: HttpClient, rootUrl: string, params: CompanyControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<Company>> {
...
companyControllerCreate.PATH = '/companies';
