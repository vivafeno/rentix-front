...
export function propertyControllerFindTrash(http: HttpClient, rootUrl: string, params?: PropertyControllerFindTrash$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
