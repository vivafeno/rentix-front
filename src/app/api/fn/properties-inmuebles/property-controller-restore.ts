...
export function propertyControllerRestore(http: HttpClient, rootUrl: string, params: PropertyControllerRestore$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
